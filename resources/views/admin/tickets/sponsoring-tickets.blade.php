...
<head>
    ...
    <title>CR - Tickets - Sponsoring </title>
</head>
<body>
        ...
        <tbody >
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4 ">
                    ...
                    @else
                    <span class="text-center text-sm font-medium rounded-full dark:text-blue-300">
                    Pending
                    </span>
                    @endif
                </td>
            ...
            <form id="updateForm" method="POST" action="/admin/register-pay" class="p-4 md:p-5">
                ...
                <div class="grid gap-4 mb-4">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="full_name" value="{{$ticket['name']}}" id="full_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" readonly>
                    </div>
                    <div class="col-span-2">
