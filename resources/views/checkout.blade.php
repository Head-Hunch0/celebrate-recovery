                    ...
                    <div class="mt-6 p-8 rounded-lg sm:mt-8 lg:flex lg:items-start lg:gap-12">
                      ...
                      <div class="mt-6 px-6 grow sm:mt-8 lg:mt-0">
                        ...
                        <div class="mt-6 flex items-center pt-10 px-6 justify-center gap-8">
                            <a href="https://www.paypal.com/ncp/payment/DYQXRE6KQ4P4C" class="flex items-center gap-8">
                            ...
                            <div class="p-4 md:p-5">
                                <form class="space-y-4" action="/mpesa/initiate" method="POST">
                                    ...
                                    <div>
                                        ...
                                        <input type="amount" name="amount" id="amount" placeholder="1000" value="{{$total}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required />
                                    </div>
