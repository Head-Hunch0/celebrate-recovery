                ...
                <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                  <div class="mx-auto max-w-5xl">
                    ...
                    <div class="mt-6 p-8 rounded-lg sm:mt-8 lg:flex lg:items-start lg:gap-12">
                      <form action="{{ route('payment') }}" method="POST" class="w-full rounded-lg border border-gray-200 bg-white p-4 px-8 shadow-lg dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:max-w-xl lg:p-8">
                        @csrf
